...
│   │   │ 스케줄러 (2분할 레이아웃)                   │                │
│   │   │ ─────────────────────────────────────────── │                │
│   │   │ [좌측: Op. Panel 동일]   [우측: 스케줄 대기열] │                │
│   │   │ · CNC 모니터 정보        · 프로그램 리스트    │                │
│   │   │ · 실시간 상태 표시       · 카운트/상태 관리   │                │
│   │   │ · (인터록 상태 바 포함)  · 삭제(X) 시 자동 정렬 │                │
│   │   └─────────────────────────────────────────────┘                │
│   │                                                                  │
│   ├─ [ Transfer ]                           [관리자/AS 전용]         │
│   │       │                                                          │
...
| 1.4 | 2026-01-23 | **UI 레이아웃 및 안전 시퀀스 강화** <br> - 로고/호기선택기를 메뉴바 상단으로 이동 <br> - 제어관련 버튼 노출 조건부(Op.Panel, Scheduler) 설정 <br> - 오퍼레이션 패널/스케줄러 2분할 레이아웃 반영 <br> - 스케줄러 테이블 컬럼 순서 및 삭제 동작(Row Shift) 정의 <br> - 인터록 위반 시 원격 제어 시퀀스 즉시 중단 및 조작 금지 강화 |
